...
enum
{
    ...
    datasealing_fcn_id_oe_log_init_ecall = 2,
    datasealing_fcn_id_oe_get_sgx_report_ecall = 3,
    datasealing_fcn_id_oe_get_report_v2_ecall = 4,
    datasealing_fcn_id_oe_verify_local_report_ecall = 5,
    datasealing_fcn_id_oe_sgx_init_context_switchless_ecall = 6,
    datasealing_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 7,
    datasealing_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

/**** Trusted function names. ****/
static const oe_ecall_info_t _datasealing_ecall_info_table[] = 
{
    { "seal_data" },
    { "unseal_data" },
    { "oe_log_init_ecall" },
...
oe_result_t datasealing_seal_data(
    ...
    data_t* sealed_data)
{
    ...
    _args.sealed_data = (data_t*)sealed_data;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(seal_data_args_t));
    if (opt_mgs)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.opt_msg_len);
    if (data)
    ...
    if (sealed_data)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(data_t));
    ...
    if (opt_mgs)
        OE_WRITE_IN_PARAM(opt_mgs, 1, _args.opt_msg_len, unsigned char*);
    if (data)
        OE_WRITE_IN_PARAM(data, 1, _args.data_size, unsigned char*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_seal_data].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(sealed_data, 1, sizeof(data_t));
    if (sealed_data && sealed_data->data)
        OE_SET_DEEPCOPY_OUT_PARAM(sealed_data->data, 1, sealed_data->size, uint8_t*);
...
OE_WEAK_ALIAS(datasealing_seal_data, seal_data);

oe_result_t datasealing_unseal_data(
    oe_enclave_t* enclave,
    int* _retval,
    ...
    data_t* output_data)
{
    ...
    memset(&_args, 0, sizeof(_args));
    _args.sealed_data = (data_t*)sealed_data;
    _args.optional_msg_flag = optional_msg_flag;
    _args.output_data = (data_t*)output_data;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(unseal_data_args_t));
    if (sealed_data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(data_t));
    if (sealed_data && sealed_data->data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.sealed_data->size);
    ...
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (sealed_data)
        OE_WRITE_IN_PARAM(sealed_data, 1, sizeof(data_t), data_t*);
    if (sealed_data && sealed_data->data)
        OE_WRITE_IN_PARAM(sealed_data->data, 1, _args.sealed_data->size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_unseal_data].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(output_data, 1, sizeof(data_t));
    if (output_data && output_data->data)
        OE_SET_DEEPCOPY_OUT_PARAM(output_data->data, 1, output_data->size, uint8_t*);
...
OE_WEAK_ALIAS(datasealing_unseal_data, unseal_data);

oe_result_t datasealing_oe_log_init_ecall(
    oe_enclave_t* enclave,
    ...
    uint32_t log_level)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_oe_log_init_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(datasealing_oe_log_init_ecall, oe_log_init_ecall);

oe_result_t datasealing_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(datasealing_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t datasealing_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(datasealing_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t datasealing_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(datasealing_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t datasealing_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(datasealing_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t datasealing_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _datasealing_ecall_info_table[datasealing_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(datasealing_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

/**** Untrusted function IDs. ****/
enum
{
    datasealing_fcn_id_oe_syscall_epoll_create1_ocall = 0,
    datasealing_fcn_id_oe_syscall_epoll_wait_ocall = 1,
    datasealing_fcn_id_oe_syscall_epoll_wake_ocall = 2,
    datasealing_fcn_id_oe_syscall_epoll_ctl_ocall = 3,
    datasealing_fcn_id_oe_syscall_epoll_close_ocall = 4,
    datasealing_fcn_id_oe_syscall_open_ocall = 5,
    datasealing_fcn_id_oe_syscall_read_ocall = 6,
    datasealing_fcn_id_oe_syscall_write_ocall = 7,
    datasealing_fcn_id_oe_syscall_readv_ocall = 8,
    datasealing_fcn_id_oe_syscall_writev_ocall = 9,
    datasealing_fcn_id_oe_syscall_lseek_ocall = 10,
    datasealing_fcn_id_oe_syscall_pread_ocall = 11,
    datasealing_fcn_id_oe_syscall_pwrite_ocall = 12,
    datasealing_fcn_id_oe_syscall_close_ocall = 13,
    datasealing_fcn_id_oe_syscall_flock_ocall = 14,
    datasealing_fcn_id_oe_syscall_fsync_ocall = 15,
    datasealing_fcn_id_oe_syscall_fdatasync_ocall = 16,
    datasealing_fcn_id_oe_syscall_dup_ocall = 17,
    datasealing_fcn_id_oe_syscall_opendir_ocall = 18,
    datasealing_fcn_id_oe_syscall_readdir_ocall = 19,
    datasealing_fcn_id_oe_syscall_rewinddir_ocall = 20,
    datasealing_fcn_id_oe_syscall_closedir_ocall = 21,
    datasealing_fcn_id_oe_syscall_stat_ocall = 22,
    datasealing_fcn_id_oe_syscall_fstat_ocall = 23,
    datasealing_fcn_id_oe_syscall_access_ocall = 24,
    datasealing_fcn_id_oe_syscall_link_ocall = 25,
    datasealing_fcn_id_oe_syscall_unlink_ocall = 26,
    datasealing_fcn_id_oe_syscall_rename_ocall = 27,
    datasealing_fcn_id_oe_syscall_truncate_ocall = 28,
    datasealing_fcn_id_oe_syscall_ftruncate_ocall = 29,
    datasealing_fcn_id_oe_syscall_mkdir_ocall = 30,
    datasealing_fcn_id_oe_syscall_rmdir_ocall = 31,
    datasealing_fcn_id_oe_syscall_fcntl_ocall = 32,
    datasealing_fcn_id_oe_syscall_ioctl_ocall = 33,
    datasealing_fcn_id_oe_syscall_poll_ocall = 34,
    datasealing_fcn_id_oe_syscall_kill_ocall = 35,
    datasealing_fcn_id_oe_syscall_close_socket_ocall = 36,
    datasealing_fcn_id_oe_syscall_socket_ocall = 37,
    datasealing_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 38,
    datasealing_fcn_id_oe_syscall_socketpair_ocall = 39,
    datasealing_fcn_id_oe_syscall_connect_ocall = 40,
    datasealing_fcn_id_oe_syscall_accept_ocall = 41,
    datasealing_fcn_id_oe_syscall_bind_ocall = 42,
    datasealing_fcn_id_oe_syscall_listen_ocall = 43,
    datasealing_fcn_id_oe_syscall_recvmsg_ocall = 44,
    datasealing_fcn_id_oe_syscall_sendmsg_ocall = 45,
    datasealing_fcn_id_oe_syscall_recv_ocall = 46,
    datasealing_fcn_id_oe_syscall_recvfrom_ocall = 47,
    datasealing_fcn_id_oe_syscall_send_ocall = 48,
    datasealing_fcn_id_oe_syscall_sendto_ocall = 49,
    datasealing_fcn_id_oe_syscall_recvv_ocall = 50,
    datasealing_fcn_id_oe_syscall_sendv_ocall = 51,
    datasealing_fcn_id_oe_syscall_shutdown_ocall = 52,
    datasealing_fcn_id_oe_syscall_setsockopt_ocall = 53,
    datasealing_fcn_id_oe_syscall_getsockopt_ocall = 54,
    datasealing_fcn_id_oe_syscall_getsockname_ocall = 55,
    datasealing_fcn_id_oe_syscall_getpeername_ocall = 56,
    datasealing_fcn_id_oe_syscall_getaddrinfo_open_ocall = 57,
    datasealing_fcn_id_oe_syscall_getaddrinfo_read_ocall = 58,
    datasealing_fcn_id_oe_syscall_getaddrinfo_close_ocall = 59,
    datasealing_fcn_id_oe_syscall_getnameinfo_ocall = 60,
    datasealing_fcn_id_oe_syscall_nanosleep_ocall = 61,
    datasealing_fcn_id_oe_syscall_clock_nanosleep_ocall = 62,
    datasealing_fcn_id_oe_syscall_getpid_ocall = 63,
    datasealing_fcn_id_oe_syscall_getppid_ocall = 64,
    datasealing_fcn_id_oe_syscall_getpgrp_ocall = 65,
    datasealing_fcn_id_oe_syscall_getuid_ocall = 66,
    datasealing_fcn_id_oe_syscall_geteuid_ocall = 67,
    datasealing_fcn_id_oe_syscall_getgid_ocall = 68,
    datasealing_fcn_id_oe_syscall_getegid_ocall = 69,
    datasealing_fcn_id_oe_syscall_getpgid_ocall = 70,
    datasealing_fcn_id_oe_syscall_getgroups_ocall = 71,
    datasealing_fcn_id_oe_syscall_uname_ocall = 72,
    datasealing_fcn_id_oe_log_is_supported_ocall = 73,
    datasealing_fcn_id_oe_log_ocall = 74,
    datasealing_fcn_id_oe_write_ocall = 75,
    datasealing_fcn_id_oe_get_supported_attester_format_ids_ocall = 76,
    datasealing_fcn_id_oe_get_qetarget_info_ocall = 77,
    datasealing_fcn_id_oe_get_quote_ocall = 78,
    datasealing_fcn_id_oe_get_quote_verification_collateral_ocall = 79,
    datasealing_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 80,
    datasealing_fcn_id_oe_verify_quote_ocall = 81,
    datasealing_fcn_id_oe_sgx_get_cpuid_table_ocall = 82,
    datasealing_fcn_id_oe_sgx_backtrace_symbols_ocall = 83,
    datasealing_fcn_id_oe_sgx_log_backtrace_ocall = 84,
    datasealing_fcn_id_oe_sgx_thread_wake_wait_ocall = 85,
    datasealing_fcn_id_oe_sgx_wake_switchless_worker_ocall = 86,
    datasealing_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 87,
    datasealing_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 88,
    datasealing_fcn_id_oe_verify_tdx_quote_ocall = 89,
...
static oe_ocall_func_t _datasealing_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _datasealing_ocall_function_table,
               90,
               _datasealing_ecall_info_table,
                8,
               enclave);
}
